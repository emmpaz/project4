    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(new Jobs(modelFields));
          if (onSuccess) {
      ...
      <TextField
        ...
        onChange={(e) => {
          ...
          if (onChange) {
            ...
            const result = onChange(modelFields);
            value = result?.pay ?? value;
          }
          if (errors.pay?.hasError) {
            runValidationTasks("pay", value);
          }
          setPay(value);
        }}
        onBlur={() => runValidationTasks("pay", pay)}
        errorMessage={errors.pay?.errorMessage}
        hasError={errors.pay?.hasError}
        {...getOverrideProps(overrides, "pay")}
      ></TextField>
      <TextField
        label="Date"
        isRequired={false}
